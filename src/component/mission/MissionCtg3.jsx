...
const MissionCtg3 = ({ location }) => {
  ...
  const callMission = async () => {
    const result = await axios.get(`/mission/categorylist?m_category=4&m_sort=&m_start=${m_page}&m_number=${m_number}`)
...
export default withRouter (MissionCtg3)